/**
 * Script to fill an offer to add liquidity on an existing contingent pool. (get offer from api service)
 * Run: `yarn diva::fillOfferAddLiquidity_from_api --network mumbai`
 */
...
async function main() {
  ...
  const offerHash =
    "0x00dcf57b9451f3d40bd99a7691ae7ef1a951502f9ac9dcecf009c4e03c91a95b";
