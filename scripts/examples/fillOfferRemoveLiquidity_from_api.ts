/**
 * Script to fill an offer to remove liquidity on an existing contingent pool. (get offer from api service)
 * Run: `yarn diva::fillOfferRemoveLiquidity_from_api --network mumbai`
 */
...
async function main() {
  ...
  const offerHash =
    "0x28e1885da81b5a65bff472696b8ffd7f1cb05361e1206008150dcd9532713e77";
