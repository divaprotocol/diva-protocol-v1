...
* Team 6 ([HiAudit](https://hiaudit.io/consulting)): 🔗 ❗DO NOT HIRE THEM! THEY ARE **NOT** THE #1 AUDITING FIRM IN JAPAN!
...
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|H-01|Wrong implementation of EVMCall in DIVAOwnershipSecondary||[🔗][H-01-T2]|||||[Fixed][PR3]|Great unique finding! We'd like to highlight that if this error made it to production, the harm would be limited as Tellor reporters could have adopted the new query type. Also, no user funds would have been at risk. Nonetheless, adhering to the proposed standard is the preferred approach.|
...
|H-03|_createContingentPoolLib is suspicious of the reorg attack|||[🔗][H-04-T3]||||Fixed ([PR29] / [PR48])|Very special finding that no one else spotted! While it involved quite a bit of work to change the `poolId` logic, it helped us to make the protocol more robust.|
...
The medium finding "Potentially In-Correct calculation of actual taker fillable amount" (see finding 3 in the HiAudit report) was excluded as the auditing team was not able to provide a better alternative.
...
|L-04|Don't allow setting owner to address(0) in DIVAOwnershipSecondary||[🔗][L-08-T2]|||||Not implemented|Not addressed as setting the owner on secondary chains equal to the zero address cannot cause any harm.|
...
|L-06|Transferring a zero value amount may revert when creating a pool|||[🔗][L-12-T3]||||[Not implemented][PR]||
|L-07|Redundant requirement when requiring the collateralAmount > 1e6 when creating a pool|||[🔗][L-13-T3]||||[Fixed][PR46]||
|L-08|Redundant check block.timestamp > submissionEndTime|||[🔗][L-14-T3]||||[Fixed][PR18]||
|L-09|unpauseReturnCollateral() will extend pause delay time even when it already unpaused||||[🔗][L-15-T4]|||[Fixed][PR35]||
|L-10|Griefer can challenge final reference value and prolonged the settlement process||||[🔗][L-16-T4]|||[Not implemented][PR]||
|L-11|Centralization Risk in token supply can result in users being unable to remove DIVA owner|||||[🔗][L-17-T5]||[Not implemented][PR]||
|L-12|Voting for a different owner can become impossible|||||[🔗][L-18-T5]||[Fixed][PR32]||
|L-13|Diamond facet upgrade|||||[🔗][L-19-T5]||[Not implemented][PR]||
|L-20|Missing interface in IERC165|🔗 (5.4)||||||[Fixed][PR44]||
|L-21|Unverified position token|🔗 (5.5)||||||[Fixed][PR42]||
|L-22|Invalid receiver of settlement fee in liquidity removal|🔗 (5.7)||||||[Fixed][PR21]||
|L-23|Un-Satisfactory check while setting up permissionedERC721Token||||||🔗 (5)|[][PR]||
|L-24|Missing validations while adding new deposit to address ||||||🔗 (7)|[][PR]||
|L-25|In-sufficient transfer check while allocating fees to `recipient`||||||🔗 (8)|[][PR]||
...
|I-04|Violation Of Checks Effects Interation Pattern|🔗 (6.2)||||[🔗][I-12-T5]||[Not implemented][PR]||
|I-13|Remove poolId from PoolStorage|🔗 (6.1)||||||[Pending][PR]||
|I-14|Improve code clarity|🔗 (6.3)||||[🔗][I-14-T5]||[Pending][PR6 / 31]||
|I-15|Use proper error for non-existing pool|🔗 (6.4)||||||[Pending][PR37 / 38 / 39 / 40 / 50]||
|I-16|Add incentive for the default settlement|🔗 (6.5)||||||[Pending][PR]||
|I-17|Optimize gas consumption|🔗 (6.6)||||||[Pending][PR18]||
|I-18|Avoid zero value transfers initiated by the protocol|🔗 (6.7)||||||[Pending][PR]||
|I-19|Consider adding white hat hacks policy|🔗 (6.9)||||||[Pending][PR]||
|I-22|Consider extending the effect of the pauseReturnCollateral function|🔗 (6.12)||||||[Pending][PR]||
|I-04|Add missing variable checks in constructor||[🔗][I-06-T2]||||🔗 (1)|[Fixed][PR31]||
|I-24|Explicit Return [ Code Readability ]||||||🔗 (2)|[][PR]||
|I-25|Unclear usage when ERC20 blacklisted user removes liquidity||||||🔗 (6)|[][PR]||
...
|ID | Description        | T1 |T2 | T3 | T4 | T5 | T6 | Status | Team comment|
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|I-26|Remove outdated comments regarding upgradeability risk and owner right restrictions in Documentation|||||||[][PR6]||
...
|ID | Description        | T1 |T2 | T3 | T4 | T5 | T6 | Status | Team comment|
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|H-01|Funds could be stuck in DIVADevelopmentFund|🔗 (5.1)|[🔗][H-02-T2]|||||[Fixed][PR8]|Important finding! We want to highlight that this issue would have only impacted the protocol owner in a scenario where someone made a donation via the `deposit` function with `_releasePeriodInSeconds = 0`. No user funds would have been at risk.|
...
|ID | Description        | T1 |T2 | T3 | T4 | T5 | T6 | Status | Team comment|
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|I-06|Add missing variable checks in constructor||[🔗][I-06-T2]||||🔗 (1)|[Fixed][PR31]||
|I-14|Improve code clarity|🔗 (6.3)||||[🔗][I-14-T5]||[Pending][PR6 / 31]||
|I-20|Remove payable mutability from withdraw function|🔗 (6.10)||||||[Pending][PR]||
|I-04|Add missing variable checks in constructor||[🔗][I-06-T2]||||🔗 (1)|[Fixed][PR31]||
...
|I-03|Use specific imports instead of just a global import in DIVAOracleTellor||[🔗][I-03-T2]|||||[Fixed][PR79]||
|I-09|Change immutable to constant if a fixed value is used||[🔗][I-09-T2]|||||[Fixed][PR79]||
|I-04|Add missing variable checks in constructor||[🔗][I-06-T2]||||🔗 (1)|[Fixed][PR31]||
...
|ID | Description        | T1 |T2 | T3 | T4 | T5 | T6 | Status | Team comment|
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|M-07|Fee-on-Transfer tokens issue in addTip functionality in Tellor adapter?|||||||[][PR82]||
|-00|Update poolId type|||||||[][PR84]||
|G-02|Minor gas optimizations|||||||[][PR85]||
...
|ID | Description        | T1 |T2 | T3 | T4 | T5 | T6 | Status | Team comment|
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|I-00|Detect duplicates in claimers' addresses|🔗 (6.8)||||||[][PR9]||
|I-00|Protect withdrawing all tokens before setting up trigger|🔗 (6.13)||||||[][PR]||
...
|ID | Description        | T1 |T2 | T3 | T4 | T5 | T6 | Status | Team comment|
| :---| :--- |:--- | :--- |:--- |:--- |:--- |:--- |:--- |:--- |
|G-01|Use custom errors instead of require to save users gas|||||||[][PR15]||
|L-26|Remove pause/unpause functionality from ClaimDIVALinearVesting contract|||||||[][PR13]||
